...
- The GOES satellite quicklink points straight at `slider.cira.colostate.edu` instead of the retired `rammb-slider` host. The old address still redirects and carries the storm and time parameters through, so existing links keep working; this just skips the hop.
