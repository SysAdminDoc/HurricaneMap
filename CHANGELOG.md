...
- Bumped the service worker shell cache to `hm-v1.3.9-q14` so installed users receive the responsive polish, similarity-vector data path, active-storm cone layer, and Storm Events panel metric.
