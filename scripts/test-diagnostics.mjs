...
const bundle = buildSanitizedSupportBundle({
  ...
  storage: {
    ...
    scopes: [
      { id: 'shell', required: true, cacheName: 'hm-shell-hm-v1.8.0', entries: 90, sizeBytes: 120000 },
...
assert.equal(bundle.app.version, '1.8.0');
assert.equal(bundle.storage.radar_pack_count, 1);
assert.equal(bundle.storage.scopes[0].cache_name, 'hm-shell-hm-v1.8.0');
