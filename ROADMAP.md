...
- [ ] **P10.1 Active forecast spaghetti ensemble** — For any active storm: fetch GFS/ECMWF/HWRF/HMON track ensemble from NOAA or TROPYCAL-compatible endpoint, render as semi-transparent spaghetti curves on the map. Toggle on/off in layers panel. Historical vs. real-time separation clear.
