...
## Phase 8 — Mobile-first responsive refinement + advanced filtering (upcoming)
...
- [ ] **P8.2 Dark/light theme toggle with persistence** — Add theme selector in settings menu (Catppuccin Mocha dark vs Latte light). Persist selection to localStorage. Smooth CSS-variable swap without page reload.
